...
**This is a full, from the ground up rewrite of [the original bba6tool](https://github.com/SettlersDev/bba6tool) originally created by yoq.**

## Usage
Unpack: Launch the executable with the path to the .bba|.s6map|.s6xmap file as argument.
Pack: Launch the executable with the path to the folder (ends with _Extracted) and `--Type: ` as arguments. (e.g. "S6Packer.exe C:\\Usermap_Extracted --Type: .s6xmap")
